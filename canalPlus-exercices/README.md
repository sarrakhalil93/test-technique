...
La solution proposée est "canalPlus-exercices" basée sur Selenium webdriver, cucumber et Junit.
...
Les tests sont écrits dans le repertoire src/specs/features avec le syntaxe Gherkin
...
- 1: A partir du class TestRunner bouton droite / Run As Junit
...
# Reporting 
Les résultats de test s’affichent dans un rapport Extent nommé canal-plus-report.html dans le dossier Target / Cucumber-reports
